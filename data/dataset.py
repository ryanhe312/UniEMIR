...
class DenoiseSR(data.Dataset):  # Denoise and super-resolution Dataset
...
class IsotropicVolume(data.Dataset):  
    def __init__(self, data_root, data_len=-1, norm=True, percent=False, phase='train', image_size=[256, 256], z_times=6, loader=pil_loader_noL):
        self.data_root = data_root
        self.phase = phase
...
class TestIsotropic(data.Dataset): 
    def __init__(self, data_root, data_len=-1, norm=True, percent=False, phase='train', image_size=[256, 256],
                 z_times=6,
                 loader=pil_loader):
        self.data_root = data_root
...
class TestAnIsotropic(data.Dataset):
    def __init__(self, data_root, data_len=-1, norm=True, percent=False, phase='train', image_size=[256, 256],
                 z_times=6,
                 loader=pil_loader):
        self.data_root = data_root
